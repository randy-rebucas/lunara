    ...
    <div className={className}>
      <div className="flex flex-wrap items-center gap-2">
        {SOCIAL_SHARE_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={`inline-flex ${buttonSize} shrink-0 items-center justify-center rounded-full transition ${PLATFORM_STYLES[option.id]}`}
            >
              <Icon />
            </button>
          );
        ...
        <button
          ...
          className={`inline-flex ${buttonSize} shrink-0 items-center justify-center rounded-full border border-border bg-white text-primary transition hover:bg-primary/5`}
        >
