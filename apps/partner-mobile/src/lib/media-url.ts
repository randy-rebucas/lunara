 ...
 * itself — rebuild those against the app's own (possibly LAN-rewritten) API origin. Any other
 * absolute URL is already a reachable host and must be passed through untouched.
 */
