          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-3">
            <section data-tour="dashboard-recent-orders" className="section-panel lg:col-span-2">
              <div className="section-panel-header flex flex-wrap items-center justify-between gap-3">
                ...
                <Link href={toPath("/orders/incoming")} className="link-primary text-sm">
                  View all →
                </Link>
              </div>
              <div className="divide-y divide-border/60">
                ...
                {data.recentOrders.map((o) => {
                  ...
                  return (
                    <Link
                      key={o._id}
                      href={toPath(partnerOrderHref(o))}
            ...
            <div className="flex flex-col gap-4">
              <section className="section-panel">
                <div className="section-panel-header flex items-center justify-between gap-3">
                  ...
                  <Link href={toPath("/revenue")} className="link-primary text-xs">
                    Details →
                  </Link>
                </div>
