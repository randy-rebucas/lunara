...
import { getAuthToken, register } from '../../lib/ai-agents-api';
  ...
  return (
    <div className="w-full max-w-md rounded-2xl bg-slate-900/60 p-6 shadow-2xl ring-1 ring-white/10 backdrop-blur-xl sm:p-8">
      ...
      <h1 className="text-center text-xl font-bold text-white">
        Create <span className="font-normal text-slate-400">your account</span>
      </h1>
      <p className="mt-1 text-center text-xs text-slate-500">
        New accounts get customer-level access to the AI team.
      </p>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative">
              <User className="pointer-events-none absolute left-3.5 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-slate-500" aria-hidden />
              <input
                id="firstName"
                type="text"
          ...
          <div>
            ...
            <input
              id="lastName"
              type="text"
              className="w-full rounded-lg bg-slate-950/50 px-4 py-2.5 text-sm text-white ring-1 ring-white/10 transition-shadow placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-400/50"
              placeholder="Cruz"
              value={lastName}
