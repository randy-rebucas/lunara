...
interface UseCustomerMessagingSocketOptions {
  conversationId: string | null;
  onNewMessage?: (msg: ChatMessage) => void;
}

/** Mirrors rider-mobile's useRiderMessagingSocket so customer support chat joins the same
...
export function useCustomerMessagingSocket({ conversationId, onNewMessage }: UseCustomerMessagingSocketOptions) {
