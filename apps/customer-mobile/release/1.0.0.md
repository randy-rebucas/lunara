...
Index of store releases. Each publish gets a versioned file under [`release/`](./release/).

| Version | Date | File |
|---------|------|------|
| 1.0.1 | June 2026 | [release/1.0.1.md](./release/1.0.1.md) |

**Trigger:** When publishing customer-mobile (EAS build, App Store, Google Play), generate or update `release/<version>.md` from git changes since the last release. See `.cursor/rules/customer-mobile-release.mdc`.
